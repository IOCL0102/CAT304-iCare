...
export default function DoctorProfileViewPage () {
    ...
    <div>
        ...
        <div className="mt-5" >
            ...
            <button type="button" onClick={()=>{navigate("/doctorprofileform")} }class="w-32 h-9 ml-20 mr-40 text-sm font-medium text-white bg-primary rounded-lg border border-primary hover:bg-primary">
