...
export default function ViewPatientListPage (){
    ...
    const displayUsers = patientCardInfo.slice(pagesVisited, pagesVisited + usersPerPage).map((patientCardInfo) => {
        return (
            <div className='mr-10 ml-20 flex-col bg-blue-500'>           
    ...
    return (
        <div>
            ...
            <div className ='bg-yellow-500 ml-20 mr-10 place-content-between flex p-2'>
                ...
                <div className='flex items-end'>
                    <button type="button" class="w-40 h-10 ml-30 text-sm font-medium text-white bg-primary rounded-lg border border-primary hover:bg-primary">Add new patient</button>
                </div>  
            </div>

            {/*============================ DISPLAY PATIENT CARD ============================ */}
            <div className="ml-0 mr-20 grid grid-cols-5 gap-4 bg-red-500">
                {displayUsers}
            </div>
            
            {/*============================ PAGINATION ============================ */}
            <div className='bg-purple-500 mt-5 ml-20 mr-40 flex justify-center'> 
                <ReactPaginate
                previousLabel={"<" }
                nextLabel={">"} 
                pageCount={pageCount}
