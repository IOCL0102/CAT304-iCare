        ...
        <form onSubmit={handleSubmit}>
            <div className=" mt-15 ml-20 mr-10 flex flex-row space-x-1 form-control ">
                <div className="bg-blue-500 ml-20 mr-10 flex space-y-1 w-1/3 form-control ">
                    ...
                    type='text' name="patientName" placeholder="John Coe" onChange={handleChange}/>
            ...
            <div className=" mt-8 ml-20 mr-10 flex flex-row space-x-5 form-control ">
                    <div className="bg-yellow-500 ml-20 mr-10 flex space-y-1 w-1/3 form-control ">
                        ...
                        <input className='bg-white w-1/2 border-2 rounded-lg border-gray-400' 
                        type='text' placeholder="0561590-08-0598" name="patientIC" onChange={handleChange}/>
                        <p className= 'text-red-500'>{formErrors.patientIC}</p>
                    </div>
                
                <div className=" bg-blue-500 ml-18 mr-10 pl-16 flex space-y-1 form-control">
            ...
            <div className=" mt-8 ml-20 mr-10 flex flex-row form-control ">
                <div className=" ml-20 mr-10 flex space-y-1 w-1/3 form-control ">
                    ...
                    <input className='bg-white border-2 rounded-lg border-gray-400' 
                    type='text' placeholder="010-8526597" name="patientPhone" onChange={handleChange}/>
                ...
                <div className=" ml-20 mr-10 flex space-y-1 w-1/3 form-control">
                    ...
                    <input className='bg-white border-2 rounded-lg border-gray-400' 
                    type='text' placeholder="icare@gmail.com" name="patientEmail" onChange={handleChange}/>
            ...
            <div className=" mt-8 ml-20 mr-10 flex flex-row form-control ">
                <div className=" ml-20 mr-10 flex space-y-1 w-1/3 form-control ">
                    ...
                    type='text' placeholder="kampung" name="patientAddress" onChange={handleChange}/>
                ...
                <div className=" ml-20 mr-10 flex space-y-1 w-1/3 form-control">
                    ...
                    <input className='bg-white border-2 h-12 rounded-lg border-gray-400' 
                    type='text' placeholder="peanut allergy" name="patientMedicalAllergies" onChange={handleChange}/>
