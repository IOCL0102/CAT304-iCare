    ...
    return (
        <div>
           <div className="absolute mt-2 right-20 space-x-4">
                    ...
                    <button onClick={()=>{navigate("/doctorprofileview")}}type="button" class="text-black bg-gray-50 border border-gray-300 hover:bg-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0">Dr.{doctor.name.split(" ")[0]}</button>             
            </div>     
        </div>
    )
}